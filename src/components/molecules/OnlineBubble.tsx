...
function OnlineBubble({ className, "aria-label": ariaLabel$ = "Online", ...props }: OnlineBubbleProps): JSX.Element {
  return <Bubble aria-label={ariaLabel$} className={cls("bg-green-500 border-green-500", className)} {...props} />;
}
