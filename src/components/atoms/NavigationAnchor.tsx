...
interface NavigationAnchorProps extends LinkProps, Omit<AnchorHTMLAttributes<HTMLAnchorElement>, "href"> {
  children: ReactNode;
}

const NavigationAnchor = ({ children, className, ...props }: NavigationAnchorProps): ReactElement => (
  <Link
    className={cls(
      className,
      "px-4 py-2",
