...
export default function PartyBoard({ partyId }: PartyBoardProps): JSX.Element {
  ...
  return (
    <Fragment>
      ...
      <PartyBoardProvider {...realtime} isLoading={isLoading} voteSession={voteSession}>
        <SizedBox height={30} />
        ...
        <div className='container mx-auto'>
          <div className='flex flex-col gap-8'>
            {isLoading ? (
              <Pulse>
                <Skeleton style={{ height: 400, width: "100%" }} className='rounded-xl' />
              </Pulse>
            ) : (
              <Fragment>
            ...
            <div className='flex gap-3' style={{ flexDirection: width < 1000 ? "column" : "row" }}>
              <div className='flex-1 gap-5'>
                {isLoading ? (
                  <Pulse>
                    <Skeleton style={{ height: 420, width: "100%" }} className='rounded-lg' />
                  </Pulse>
                ) : (
                  <UserStoryList />
                )}
              ...
              <div>
                {isLoading ? (
                  <Pulse>
                    <Skeleton style={{ height: 300, minWidth: 500 }} className='rounded-lg' />
                  </Pulse>
                ) : (
                  <VotingResults />
                )}
