...
function UserStoryListItemActions({
  storyId,
  ...
  const handleSkipStory = useCallback(() => {
    ...
    const newStories = [...filteredStories, computedStory];
  ...
  const handleStartVote = useCallback(() => {
    ...
    const newStories = [computedStory, ...filteredStories];
...
export default UserStoryListItemActions;
