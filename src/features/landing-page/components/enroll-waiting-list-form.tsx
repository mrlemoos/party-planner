  ...
  return (
    <Fragment>
      <Paragraph className='md:max-w-[68rem]'>
        As Party&Planning is still in beta, we are actively picking sign-ups to help us with feedback of the Party
        Planner experience. If you would like to be notified when we open up to new users in this beta phase, please
